...
public class PlayerController : MonoBehaviour
{
    ...
    private void _Move()
    {
        ...
        {
           transform.position = new Vector2(transform.position.x, Mathf.Lerp(transform.position.y, m_touchesEnded.y, mVerticalTValue));
        }
        else
        {
            Vector2 newVelocity = m_rigidBody.velocity + new Vector2(0.0f, mVerticalSpeed * direction);
    ...
    private void _CheckBounds()
    {
        ...
        {
            transform.position = new Vector3(transform.position.x, mVerticalBoundary, 0.0f);
        }
